...
public:
	...
	void onMode1Toggled(bool isChecked);
	void onMode2Toggled(bool isChecked);
	void onMode3Toggled(bool isChecked);

	void onAes128Toggled(bool isChecked);
	void onAes192Toggled(bool isChecked);
	void onAes256Toggled(bool isChecked);

	void onScheduledGroupToggled(bool isChecked);
	void onOnceToggled(bool isChecked);
